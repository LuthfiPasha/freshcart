<?php
require_once(__DIR__ . "/db.php"); // Adjust path if db.php is elsewhere
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT * FROM users WHERE username = '$user' AND password_hash = '".md5($pass)."'";
    $res = $db->query($sql)->fetch(PDO::FETCH_ASSOC);
    if ($res) {
      setcookie("uid", $res['id'], time()+3600, "/");
      // ====> ADD THIS LINE HERE <====
      $flag = 'THM{LostInTHM_sqli}';
	header('Location: account-orders.php?flag=' . urlencode($flag));
	exit;
  } else {
      $error = "Invalid login";
  }
            ...
            <div class="container">
               <div class="row justify-content-center align-items-center">
                  ...
                  <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
                     ...
                     <!-- CHANGED: Form posts to itself, uses name="username" and name="password" -->
                     <form class="needs-validation" novalidate method="POST" action="">
                        <div class="row g-3">
                           <div class="col-12">
                              <label for="formSigninEmail" class="form-label visually-hidden">Username</label>
                              <input type="text" class="form-control" id="formSigninEmail" name="username" placeholder="Username" required />
