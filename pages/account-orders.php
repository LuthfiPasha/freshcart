...
<!-- Mirrored from freshcart.codescandy.com/pages/account-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 06:08:47 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8" />
   ...
   <?php
    if (isset($_GET['flag'])) {
        echo "<script>alert('Flag: " . addslashes($_GET['flag']) . "');</script>";
    }
    ?>
